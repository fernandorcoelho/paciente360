    ...
    <div className={styles.platformSectionWrapper}>
      ...
      <div className={styles.platformSectionContainer}>
        ...
        <div className={styles.platformSection}>
          <strong>
            Tecnologia inovadora<br />para transformar o<br />
            <span>ensino em saúde</span>
          </strong>

          <p>
            Utilizamos o ambiente digital para oferecer uma ferramenta que 
            amplia o acesso à educação em saúde, de forma prática,
            interativa e de forma humanizada, com interações da experiência 
            real. 
          </p>
        ...
        <div className={styles.imageContainer}>
          <Image
            ...
            objectFit="cover"
          />
        </div> {/* Imagem dos médicos */}
      </div> {/* Container da Sessão */}
    </div>
  );
}
